document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, rule, param) {
      ...
      const messages = {
        ...
        minLength: label.trim() + ' must be at least ' + param + ' characters.',
        phone: 'Please enter a valid phone number.'
      };

      return messages[rule] || label.trim() + ' is invalid.';
    };
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el) {
      ...
      if (!el.dataset.animateDelay) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Maza-w-salata משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c377dde3-133b-49ad-b1f1-701f4b2f4b04',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c377dde3-133b-49ad-b1f1-701f4b2f4b04';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c377dde3-133b-49ad-b1f1-701f4b2f4b04';
